...
export type ResolversParentTypes = {
  ...
  Int: Scalars["Int"];
  AstronautResult:
    | ResolversParentTypes["Astronaut"]
...
> = {
  ...
  subType?: Resolver<
    Maybe<ResolversTypes["MEDIA_SUB_TYPE_ENUM"]>,
    ParentType,
    ContextType
  >;
...
> = {
  ...
  >;
  astronaut?: Resolver<
    ResolversTypes["AstronautResult"],
    ParentType,
    ContextType,
    RequireFields<QueryAstronautArgs, never>
  >;
  missions?: Resolver<
...
export type AstronautResultResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["AstronautResult"] = ResolversParentTypes["AstronautResult"]
> = {
